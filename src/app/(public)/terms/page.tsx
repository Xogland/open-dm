...
export default function TermsPage() {
    ...
    return (
        <div className="container px-4 py-24 mx-auto max-w-4xl">
            <div className="mb-12">
                <Typography variant="h1" className="mb-4 text-4xl">Terms & Conditions</Typography>
            ...
            <div className="space-y-12 text-foreground/90 leading-[1.8] text-sm md:text-base">
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">1. FORMAL BINDING AGREEMENT</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">2. DEFINITIONS AND INTERPRETATION</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">3. SERVICE PROVISION AND MODIFICATIONS</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">4. REGISTRATION AND ACCOUNT SECURITY</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">5. SUBSCRIPTIONS AND MERCHANT OF RECORD</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">6. BILLING CYCLES AND AUTOMATIC RENEWALS</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">7. REFUND POLICY AND GUARANTEES</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">8. INTELLECTUAL PROPERTY OWNERSHIP</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">9. USER CONTENT AND DATA OWNERSHIP</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">10. PROHIBITED ACTIVITIES AND CONDUCT</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">11. PRIVACY AND DATA PROTECTION</Typography>
                    <Typography>
                        Your privacy is of the utmost importance to us. Our collection and use of personal information in connection with the Service is described in our Privacy Policy, which is located at <Link href="/privacy" className="text-primary hover:underline">opendm.io/privacy</Link>. You understand that through your use of the Service, you consent to the collection and use (as set forth in the Privacy Policy) of this information, including the transfer of this information to the United States and other countries for storage, processing, and use by OpenDM and its trusted sub-processors.
                    </Typography>
                    <Typography className="mt-4">
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">12. LIMITATION OF LIABILITY</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">13. DISCLAIMER OF WARRANTIES</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">14. INDEMNIFICATION CLAUSE</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">15. TERMINATION AND SUSPENSION</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">16. GOVERNING LAW AND JURISDICTION</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">17. DISPUTE RESOLUTION AND ARBITRATION</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">18. ENTIRE AGREEMENT AND SEVERABILITY</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">19. FORCE MAJEURE AND ACTS OF GOD</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">20. CHANGES TO THE TERMS AND CONDITIONS</Typography>
                    <Typography>
                ...
                <section>
                    <Typography variant="h2" className="text-xl mb-4 border-b pb-2">21. CONTACT AND LEGAL NOTICES</Typography>
                    <Typography>
