  ...
  return (
    <Card className="overflow-hidden">
      ...
      <CardContent className="p-6">
        ...
        <div className="mt-8 pt-6 border-t flex items-center justify-between opacity-50 hover:opacity-100 transition-opacity">
          <div className="flex items-center gap-2">
            <Image src="/opendm.png" alt="OpenDM" width={16} height={16} />
            <span className="text-[10px] font-bold text-muted-foreground">Powered by OpenDM</span>
          </div>
          <p className="text-[10px] text-muted-foreground font-medium">Verify your public handle above.</p>
        </div>
      </CardContent>
    </Card>
  );
